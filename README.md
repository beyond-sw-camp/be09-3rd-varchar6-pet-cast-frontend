...
| FROM | COMMENT |
| :---: | :--- |
|기우석|서로 모르는 부분을 공유하고 해결하여 프로젝트를 하는데 고도화를 할 수 있게 많이 도와주셨습니다. <br> 빠듯한 프로젝트 기간에도 웃음을 잃지 않게 해주셔서 감사합니다.|
|방동호|정말 재미나신 분이시죠. <br> 팀원 분들이 다들 매우 몰입해서 미팅을 진행을 해서 기획부터 회의를 길게하는 일이 정말 많았습니다. <br> 회의가 길어져 다들 지쳐갈 때 분위기를 한 번 흔들어 주시는 농담을 던지며 모두 으쌰으쌰하게 끔 이끌어 주셨습니다.|
|이효진|저희 조의 재간둥이 같으신 분입니다. <br> 팀 분위기를 맡아주시고 항상 나서서 하고 배우려는 자세 멋있으십니다. <br> 항상 배려해주셔서 감사합니다! |
|용길한|의혁님께서 회원 도메인을 맡아 복잡한 데이터 구조와 다양한 연관 관계를 정리해주셔서 감사합니다. <br> 유효 회원 검증 기능 구현을 통해 시스템의 안정성 향상에 기여하셨고, <br> 토큰의 정보를 활용하여 원하는 회원정보를 원활하게 처리하여 시스템의 통합성을 높이는 데 기여하셨습니다. <br> 짧은 시간 안에 핵심 기능들을 완성한 것은 정말 대단한 성과입니다. <br> 앞으로도 팀의 핵심 시스템을 안정적으로 운영하는 데 중요한 역할을 해주실 거라 믿습니다.|
|정준서|의혁님은 언제나 팀의 분위기 메이커로서 활력을 불어넣어 주셨습니다. <br> 어려운 상황에서도 웃음을 잃지 않으며 팀의 사기를 높여주셨고, <br> 아이디어의 공유와 문제 해결 능력 덕분에 수월하게 프로젝트 진행이 되었습니다.|
...
| FROM | COMMENT |
| :---: | :--- |
|기우석|프로젝트 주제에 대한 제시와 함께 가지고 있었던 요구사항들을 제시해주셔서 정량화를 하는데 시일이 큰 단축이 되었습니다. <br> 프로젝트 기간 동안 고생하셨습니다.|
|송의혁|쉽게 팀원들이 놓치는 부분들을 특유의 꼼꼼함으로 잘 메꿔주셨고, <br> 끝까지 완성하려고 하는 꾸준함과 끈기가 팀에 큰 도움을 주었습니다.|
|방동호|정말 묵묵히 자신이 맡은 일을 끝까지 인내를 갖고 하시는 분입니다. <br> 저번 프로젝트부터 같이 해오며 함께 고난과 역경을 이겨내고있습니다. <br> 그런 상황에서 보통이라면 포기할 법도 했을 텐데, <br> 끝까지 서로가 서로에게 힘이되며 도움이 되셨던 분입니다.|
|용길한|효진님께서 서비스의 핵심 기능 구현을 맡아주셔서 정말 감사합니다. <br> 특히, 처음 시도하는 복잡한 기능을 짧은 시간 안에 완성하기 위해 밤늦도록 고생하신 모습이 인상적이었습니다. <br> 기획서와 견적서 부분을 성공적으로 구현하신 것은 팀 전체에 큰 도움이 되었습니다. <br> 전체적인 프로젝트 구성과 구체화를 통해 핵심 기능 구현에 기여하셨습니다. <br> 앞으로도 이러한 열정과 능력을 바탕으로 더욱 발전하는 모습 기대하겠습니다.|
|정준서|꼼꼼한 성격 덕분에 팀원들이 놓칠 수 있는 세부 사항까지 잘 챙겨주셨고, <br> 자신의 일을 끝까지 책임감 있게 처리하시는 모습에서 감명 받았습니다. <br> 끝까지 최선을 다해주셔서 감사합니다.|
...
| FROM | COMMENT |
| :---: | :--- |
|기우석|팀 미팅이나 문서 정리를 통해서 팀 페이지를 꾸려 나가시는 데에 지분을 가지고 계십니다. <br> 프로젝트에서 진행자 역할을 하며 어려운 일을 맡아서 하셨습니다.|
|송의혁|까다로웠던 부분들을 앞장서서 해결하려고 노력하시고, <br> 전체적인 흐름을 잘 잡아주셔서 프로젝트에 큰 기여를 하셨습니다.|
|이효진|저희 조의 길잡이십니다! <br> 항상 배우려는 자세와 꾸준히 공부 하시는 모습에 많이 배웠습니다. <br> 프로젝트에서도 방향을 잡아주시고 도움 주셔서 감사합니다! |
|방동호|의욕이 매우 강하신 분입니다.<br>  지금 같은 팀이 됐는지 두달이 거의 다 되어가고 있습니다. <br> 그런데도 이 분은 평소에 잠은 언제 주무시는지 잘 모르겠습니다. 항상 프로젝트를 진행할 때 미리 생각해 오셔서 프로젝트의 방향성과 프로젝트의 기반같은 것들을 세워 모두가 좋은 틀 안에서 따라갈수 있도록 해주셨던 의욕이 강하신 분입니다.|
|정준서|팀의 길잡이이자 추진력이 강한 분입니다. <br> 팀 미팅을 주도하며 문서 정리와 팀의 진행 상황을 꼼꼼하게 챙겨주셨고, <br> 어려운 부분에서도 앞장서서 해결책을 찾으려고 노력하시는 모습이 인상적이었습니다. <br> 팀의 전체적인 흐름을 잡아주고, 프로젝트가 차질 없이 진행될 수 있도록 큰 기여를 해주셨습니다. <br> 그 헌신과 리더십에 감사드립니다.|
...
| FROM | COMMENT |
| :---: | :--- |
|기우석|깊은 이해를 바탕으로 구현에 적용하는 능력과 개발 상에 <br> 필요한 체크리스트가 머리 속에 있는 것 같은 대답을 통해 항상 믿고 컨펌을 받을 수 있어 감사했습니다. |
|송의혁|팀원들의 모자란 부분을 잘 캐치하여 보완해주시고, <br> 본인의 작업 뿐 아니라 다른 분들이 어려워 하는 점들을 도와주셔서 문제점들이 잘 해결되었습니다.|
|이효진|저희 조의 챗gpt같은 존재! <br> 항상 바쁘신 대도 물어보면 알려주시고 프로젝트에 있어서도 많이 알려주셔서 감사합니다! |
|용길한|준서님께서는 복잡한 고객 요구사항을 명확하게 정의하고, <br> 사용자 스토리를 구성하여 원활한 의사소통을 이끌었습니다. <br> 정기적인 스크럼을 통해 팀원들과 소통하며 유연하게 일정을 조정했습니다. <br> 또한 기본적인 핵심 기능 구현에 그치지 않고 Gateway 및 service-discovery/configuration 구성과 통합된 MSA 환경을 구축해주셨기에, <br> 각 micro-service들에 대한 통신을 원할하게 할 수 있었습니다.|
|방동호|준서님한테는 그냥 ‘감사합니다.’ 라는 말 이외는 표현할 방법이 없네요. <br> Spring, MSA 처음 나가는 날 도저히 수업을 따라 갈 수가 없었습니다. <br> 근데, 그 때!! 항상 제가 모르는 부분을 하나하나를 짚어가며 알려주시고, <br> 주말에도 모르는게 생겨서 해결이 안되고 있을 때 매우 빠르게 답장해주시며 <br> 정말정말 저의 Spring, MSA 기반은 준서님이 만들어 주셨다고 해도 과언이 아닙니다. 감사해요:)|
