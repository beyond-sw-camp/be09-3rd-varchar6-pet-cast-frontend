...
public class EstimateController {
    ...
    // 고객 견적서 목록 조회
    @GetMapping("/{memberId}")
    public ResponseEntity<List<EstimateResponseDTO>> getAllEstimatesByMember(@PathVariable int memberId) {
    ...
    public ResponseEntity<List<EstimateResponseDTO>> getAllEstimatesByCompany(@PathVariable int companyId) {
    ...
    public ResponseEntity<EstimateResponseDTO> getEstimateById(@PathVariable int estimateId) {
